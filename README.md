...
- Рекомендуется увеличить использование внутренней валюты посредством:
  ...
  - редоставления дополнительной валюты за выполнение специальных квестов. Также важно пересмотреть перечень продаваемых эпических предметов, выведя из оборота устаревшие и низкодоходные объекты, и стимулируя продажи наиболее востребованных товаров, предложив скидку при оплате внутренней валютой.
